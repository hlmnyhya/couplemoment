...
<body>
  ...
  <path d="M16.3561 15.6773C11.4086 24.2466 11.9132 33.8005 17.4833 37.0165C23.0535 40.2323 31.5797 35.8925 36.5273 27.3231C41.4748 18.7536 40.9701 9.19976 35.4 5.98388C29.8299 2.76797 21.3036 7.10785 16.3561 15.6773Z" stroke="#FCFCFC" stroke-width="4.07759" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-sm-12 col-lg-12 site-navigation text-center">
            <ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu">
              ...
              <li><a href="https://wa.me/+6281528464820?text=Hi!%20Couple Moment,%20apakah%20saya%20bisa%20bisa%20bergabung%20menjadi%20bagian%20dari%20reseller%20?" target="_blank">Menjadi Reseller</a></li>
            </ul>
    ...
    <div class="hero-slant overlay" id="home" data-stellar-background-ratio="0.5" style="background-image: url('frontend/images/mesh-gradient3.png')">
          ...
          <div class="col-lg-5 mb-5 section-title" data-aos="fade-up" data-aos-delay="0">
           ...
           <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group">
                ...
                <textarea maxlength="100" class="form-control" name="message" placeholder="Maks 100 karakter." rows="5" required></textarea>
              </div>
              {{-- <div class="my-3">
            ...
            <div class="testimonial--wrap">
              <div class="owl-single owl-carousel no-dots no-nav mb-5">
                <div class="testimonial-item">
                  <div class="d-flex align-items-center mb-4">
                    <div class="photo mr-3">
                      <img src="{{ asset('frontend/images/person_4-min.jp')}}g" alt="Image" class="img-fluid">
                    </div>
                    <div class="author">
                ...
                <div class="testimonial-item">
                  <div class="d-flex align-items-center mb-4">
                    <div class="photo mr-3">
                      <img src="{{ asset('frontend/images/person_1-min.jp')}}g" alt="Image" class="img-fluid">
                    </div>
                    <div class="author">
                      <cite class="d-block mb-0">Kaila Woodland</cite>
                      <span>Owner, Greenland, Inc.</span>
                ...
                <div class="testimonial-item">
                  <div class="d-flex align-items-center mb-4">
                    <div class="photo mr-3">
                      <img src="{{ asset('frontend/images/person_2-min.jp')}}g" alt="Image" class="img-fluid">
                    </div>
                    <div class="author">
                      <cite class="d-block mb-0">Kaila Woodland</cite>
                      <span>Owner, Greenland, Inc.</span>
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-lg-4">
            ...
            <div class="widget">
              ...
              <img src="{{ asset('frontend/images/subsection-channel-alt-latest.png') }}" alt=" images" class="img-fluid animated" alt="">
            </div>
          </div>
