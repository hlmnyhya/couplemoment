...
<body>
                ...
                <ul class="dropdown">
                  ...
                  <li><a href="#">Menu Three</a></li>
                    ...
                    <ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right menu-absolute">
                        <li class="cta-button"><a href="https://untree.co/" target="_blank"><strong>Daftar /
                                    Masuk</strong></a></li>
                    </ul>
    ...
    {{-- <div class="py-3">
      <div class="container">
        ...
        <div class="owl-logos owl-carousel">
          <div class="item">
            <img src="{{ asset('frontend/images/logo-puma.png')}}" alt="Image" class="img-fluid">
          </div>
          <div class="item">
            <img src="{{ asset('frontend/images/logo-adobe.pn')}}g" alt="Image" class="img-fluid">
          </div>
          <div class="item">
            <img src="{{ asset('frontend/images/logo-google.p')}}ng" alt="Image" class="img-fluid">
          </div>
          <div class="item">
            <img src="{{ asset('frontend/images/logo-paypal.p')}}ng" alt="Image" class="img-fluid">
          </div>
          <div class="item">
            <img src="{{ asset('frontend/images/logo-adobe.pn')}}g" alt="Image" class="img-fluid">
          </div>
            ...
            <div class="section-title text-center mb-5" data-aos="fade-up" data-aos-delay="0">
                ...
                <div class="switch-plan">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <div class="period"><span class="mr-2">Yearly</span><span class="save-percent">Save
                                25%</span></div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                      ...
                      <div>Year</div>
                        ...
                        <ul class="list-unstyled mb-4">
                            <li class="d-flex"><span class="feather-check-square mr-2 mt-1"></span><span>Far far away,
                                    behind the word mountains</span></li>
                            <li class="d-flex"><span class="feather-check-square mr-2 mt-1"></span><span>Far far away,
                                    behind the word mountains</span></li>
                        </ul>
                        <div>
    ...
    {{-- <div class="site-section overlay site-cover-2" style="background-image: url('frontend/images/img_v_4-min.jpg')">
      <div class="container">
        <div class="row">
