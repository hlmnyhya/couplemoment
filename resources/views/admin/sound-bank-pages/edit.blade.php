...
<body>
                    ...
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            ...
                            <div class="prism-toggle">
                                {{-- <a href="{{ route('soundbank.create') }}" class="btn btn-sm btn-primary-light">Add Sound <i class="ri-soundcloud-line"></i></a> --}}
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="col">
    ...
    {{-- <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-lg-12 mb-3">
        ...
        <input class="form-control time-format-2" id="duration" name="duration" placeholder="hh:mm" value="{{ $soundBank->duration }}">
    </div> --}}
    ...
    <!-- Cleave.js -->
    {{-- <script src="{{asset('backend')}}/dist/assets/libs/cleave.js/cleave.min.js"></script> --}}
