...
>
    ...
    <head>
        ...
        <meta
            name="Author"
            content="Spruko Technologies Private Limited"
        >
        <meta
            name="keywords"
        ...
        <link
            rel="icon"
            href="{{ asset('backend') }}/dist/assets/images/brand-logos/favicon.ico"
            type="image/x-icon"
        >
        ...
        <link
            id="style"
            href="{{ asset('backend') }}/dist/assets/libs/bootstrap/css/bootstrap.min.css"
            rel="stylesheet"
        >

        <!-- Style Css -->
        <link
            href="{{ asset('backend') }}/dist/assets/css/styles.min.css"
            rel="stylesheet"
        >

        <!-- Icons Css -->
        <link
            href="{{ asset('backend') }}/dist/assets/css/icons.css"
            rel="stylesheet"
        >

        <!-- Node Waves Css -->
        <link
            href="{{ asset('backend') }}/dist/assets/libs/node-waves/waves.min.css"
            rel="stylesheet"
        >

        <!-- Simplebar Css -->
        <link
            href="{{ asset('backend') }}/dist/assets/libs/simplebar/simplebar.min.css"
            rel="stylesheet"
        >
        ...
        <link
            rel="stylesheet"
            href="{{ asset('backend') }}/dist/assets/libs/flatpickr/flatpickr.min.css"
        >
        <link
            rel="stylesheet"
            href="{{ asset('backend') }}/dist/assets/libs/@simonwep/pickr/themes/nano.min.css"
        >
        ...
        <link
            rel="stylesheet"
            href="{{ asset('backend') }}/dist/assets/libs/jsvectormap/css/jsvectormap.min.css"
        >

        <!-- Swiper Css -->
        <link
            rel="stylesheet"
            href="{{ asset('backend') }}/dist/assets/libs/swiper/swiper-bundle.min.css"
        >

        <!-- Grid Css -->
        <link
            rel="stylesheet"
            href="{{ asset('backend') }}/dist/assets/libs/gridjs/theme/mermaid.min.css"
        >
        ...
        <link
            rel="stylesheet"
            href="{{ asset('backend') }}/assets/libs/sweetalert2/sweetalert2.min.css"
        >
        <link
            rel="stylesheet"
            type="text/css"
    ...
    <body>
                        ...
                        <div>
                            <div class="theme-colors">
                                ...
                                <div class="px-4 pb-3 text-muted fs-11">Note:If you want to change color Menu
                                    dynamically change from below Theme Primary color picker</div>
                            </div>
                            <div class="theme-colors">
        ...
        <div id="loader">
            <img
                src="{{ asset('backend') }}/dist/assets/images/media/loader.svg"
                alt=""
            >
        </div>
        <!-- Loader -->
        ...
        <div class="page">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="btn-group"
                                                            role="group"
                                                            aria-label="SoundBank Actions"
                                                        >
                                                            <a
                                                                href="{{ route('soundbank.edit', $soundBank->id) }}"
                                                                class="btn btn-sm btn-primary"
                                                            >
                                                                <i class="ri-edit-2-line"></i>
                                                            </a> |
                                                            <form
                                                                action="{{ route('soundbank.destroy', $soundBank->id) }}"
                                                                method="POST"
                                                            >
                                                                @csrf
                                                                @method('DELETE')
                        ...
                        <div class="modal-body">
                            <div class="input-group">
                                ...
                                <a
                                    ...
                                    class="input-group-text"
                                    id="voice-search"
                                ><i class="fe fe-mic header-link-icon"></i></a>
                                <a
                                    href="javascript:void(0);"
                            ...
                            <div class="my-4">
                                ...
                                <div class="p-2 border br-5 d-flex align-items-center text-muted mb-2 alert">
                                    ...
                                    <a
                                        ...
                                        aria-label="Close"
                                    ><i class="fe fe-x text-muted"></i></a>
                                </div>
                                <div class="p-2 border br-5 d-flex align-items-center text-muted mb-2 alert">
            ...
            >
                <div class="offcanvas-header border-bottom bg-primary text-fixed-white">
                    <h6
                        class="offcanvas-title d-inline-flex text-fixed-white"
                ...
                <div class="offcanvas-body p-0">
                    ...
                    >
                        <button
                            ...
                            aria-selected="true"
                        ><i class="d-inline-flex fe fe-settings me-1"></i> Feeds</button>
                        <button
                            class="nav-link"
                            id="sidebar-side2"
                            data-bs-toggle="tab"
                            ...
                            aria-selected="false"
                        ><i class="d-inline-flex fe fe-message-circle me-1"></i>Chat</button>
                        <button
                            class="nav-link"
                            id="sidebar-side3"
                            data-bs-toggle="tab"
                            ...
                            aria-selected="false"
                        ><i class="d-inline-flex fe fe-anchor me-1"></i>Timeline</button>
                    </nav>
                    <div class="tab-content">
                        ...
                        >
                                        ...
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                                            ...
                                            <div>
                                                <a
                                                    ...
                                                    href="javascript:void(0)"
                                                    class="text-primary"
                                                ><i class="fe fe-settings me-1"></i></a>
                                                <a
                                                    aria-label="anchor"
                                                    href="javascript:void(0)"
                                                    class="text-primary"
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 mb-sm-0 mb-3">
                                        <span class="feeds avatar avatar-sm avatar-rounded bg-secondary-transparent"><i
                                                class="fe fe-shopping-cart text-secondary"
                                            ></i></span>
                                    </div>
                                    <div class="col-sm-10 ps-sm-0 my-auto">
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 mb-sm-0 mb-3">
                                        <span class="feeds avatar avatar-sm avatar-rounded bg-warning-transparent"><i
                                                class="fe fe-gitlab text-warning"
                                            ></i></span>
                                    </div>
                                    <div class="col-sm-10 ps-sm-0 my-auto">
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 mb-sm-0 mb-3">
                                        <span class="feeds avatar avatar-sm avatar-rounded bg-pink-transparent"><i
                                                class="fe fe-database text-pink"
                                            ></i></span>
                                    </div>
                                    <div class="col-sm-10 ps-sm-0 my-auto">
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                                ...
                                <div class="row">
                                    <div class="col-sm-2 mb-sm-0 mb-3">
                                        <span class="feeds avatar avatar-sm avatar-rounded bg-info-transparent"><i
                                                class="fe fe-check-circle text-info"
                                            ></i></span>
                                    </div>
                                    <div class="col-sm-10 ps-sm-0 my-auto">
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                            ...
                            <div class="py-3 px-4 pt-0">
                                <div class="row mb-3">
                                    <div class="col-sm-2 mb-sm-0 mb-3">
                                        <span class="feeds avatar avatar-sm avatar-rounded bg-primary-transparent"><i
                                                class="fe fe-settings text-primary"
                                            ></i></span>
                                    </div>
                                    <div class="col-sm-10 ps-sm-0 my-auto">
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 mb-sm-0 mb-3">
                                        <span class="feeds avatar avatar-sm avatar-rounded bg-secondary-transparent"><i
                                                class="fe fe-map-pin text-secondary"
                                            ></i></span>
                                    </div>
                                    <div class="col-sm-10 ps-sm-0 my-auto">
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 mb-sm-0 mb-3">
                                        <span class="feeds avatar avatar-sm avatar-rounded bg-danger-transparent"><i
                                                class="fe fe-headphones text-danger"
                                            ></i></span>
                                    </div>
                                    <div class="col-sm-10 ps-sm-0 my-auto">
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 mb-sm-0 mb-3">
                                        <span class="feeds avatar avatar-sm avatar-rounded bg-warning-transparent"><i
                                                class="fe fe-credit-card text-warning"
                                            ></i></span>
                                    </div>
                                    <div class="col-sm-10 ps-sm-0 my-auto">
                                        <div class="d-flex align-items-end justify-content-between ms-2">
                        ...
                        <div
                            class="tab-pane fade border-0 p-0"
                        ...
                        >
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/2.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md online avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/11.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/10.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/13.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md online avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/12.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/15.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-0 px-3">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/4.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md online avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/7.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/9.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                            ...
                            <div class="d-flex align-items-center py-3 px-3 pt-0">
                                <div class="me-2">
                                    <span
                                        class="avatar avatar-md avatar-rounded cover-image"
                                        data-bs-image-src="{{ asset('backend') }}/dist/assets/images/faces/14.jpg"
                                    ></span>
                                </div>
                                <div class="">
                                    <a href="chat.html">
                        ...
                        <div
                            class="tab-pane fade border-0 p-3"
                                ...
                                <li class="d-sm-flex">
                                    ...
                                    <div class="ms-auto d-md-flex task-icon-link">
                                        ...
                                        <a
                                            ...
                                            href="javascript:void(0)"
                                            class="text-muted"
                                        ><i class="fe fe-trash-2 fs-12"></i></a>
                                    </div>
                                </li>
                                <li class="d-sm-flex">
                                    <div>
