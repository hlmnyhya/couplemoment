...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <!-- PAGE-HEADER END -->
                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex justify-content-center mb-4">
                        <ul class="nav nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab1" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pricing-monthly11" data-bs-toggle="tab"
                                    data-bs-target="#pricing-monthly11-pane" type="button" role="tab"
                                    aria-controls="pricing-monthly11-pane" aria-selected="true">Monthly</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pricing-yearly11" data-bs-toggle="tab"
                                    data-bs-target="#pricing-yearly11-pane" type="button" role="tab"
                                    aria-controls="pricing-yearly11-pane" aria-selected="false">Yearly</button>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content" id="myTabContent11">
                        <div class="tab-pane show active p-0 border-0" id="pricing-monthly11-pane"
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4">
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li class="d-grid">
                                                        <button class="btn btn-primary btn-wave" type="button">Choose Plan</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane p-0 border-0" id="pricing-yearly11-pane"
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 border-end border-inline-end-dashed pe-0">
                                            <div class="p-4">
                                                ...
                                                <div class="d-grid">
                                                    <button class="btn btn-primary-light btn-wave" type="button">Get Started</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 ps-0">
                                            <div class="p-4 pricing-offer overflow-hidden">
                                                ...
                                                <div class="d-grid">
                                                    <button class="btn btn-primary btn-wave" type="button">Get Started</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <!-- Start::row-4 -->
            <div class="row justify-content-center">
                <div class="col-xxl-10 col-xl-12 col-md-12 col-lg-12 col-sm-12">
                    <div class="row justify-content-center">
                        <div class="col-xl-9">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <button class="btn btn-primary btn-wave" type="button">Choose
                                                    Plan</button>
                                            </td>
                                            <td class="border-bottom-0">
                                                <button class="btn btn-primary btn-wave" type="button">Choose
