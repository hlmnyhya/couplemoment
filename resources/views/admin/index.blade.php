                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="ms-auto">
                                    <div class="chart-wrapper mt-1">
                                        <canvas id="leadschart" class="chart-dropshadow"></canvas>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xxl-9">
                    <div class="card overflow-hidden">
                        <div class="card-header text-center">
                            ...
                            <p>Temukan pengalaman baru dengan layanan kami.</p>
                        </div>
                        <div class="card-body">
                            <div class="jumbotron">
                                <img src="{{ asset('backend') }}/dist/assets/images/media/informasi-1.png"
                                    alt="Deskripsi Gambar" class="img-fluid">
                                <hr class="my-4">
                                <p class="text-center">
                                    <a class="btn btn-primary"
                                        href="https://wa.me/+6281528464820?text=Hi!%20Couple Moment,%20apakah%20saya%20bisa%20upgrade%20akun%20saya."
                                        role="button">Upgrade Akun Anda</a>
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive mt-2 text-center">
                                <table class="table text-nowrap border-dashed mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="border-bottom-0 text-start p-3 d-flex align-items-center"><span
                                                    class="sales-icon text-danger bg-danger-transparent"><i
                                                        class="bi bi-tablet"></i></span>Tablets</td>
                            ...
                            <div class="browser-stats">
                                <div class="row mb-3">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="{{ asset('backend') }}/dist/assets/images/browsers/chrome.svg"
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="{{ asset('backend') }}/dist/assets/images/browsers/opera.svg"
                                            class="img-fluid" alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="{{ asset('backend') }}/dist/assets/images/browsers/ie.svg"
                                            class="img-fluid" alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="{{ asset('backend') }}/dist/assets/images/browsers/firefox.svg"
                                            class="img-fluid" alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="{{ asset('backend') }}/dist/assets/images/browsers/edge.svg"
                                            class="img-fluid" alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="{{ asset('backend') }}/dist/assets/images/browsers/safari.svg"
                                            class="img-fluid" alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="{{ asset('backend') }}/dist/assets/images/browsers/netscape.svg"
                                            class="img-fluid" alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar cover-image avatar-sm"
                                                                data-bs-image-src="{{ asset('backend') }}/dist/assets/images/ecommerce/orders/9.jpg"></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar cover-image avatar-sm"
                                                                data-bs-image-src="{{ asset('backend') }}/dist/assets/images/ecommerce/orders/11.jpg"></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar cover-image avatar-sm"
                                                                data-bs-image-src="{{ asset('backend') }}/dist/assets/images/ecommerce/orders/4.jpg"></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar cover-image avatar-sm"
                                                                data-bs-image-src="{{ asset('backend') }}/dist/assets/images/ecommerce/orders/8.jpg"></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar cover-image avatar-sm"
                                                                data-bs-image-src="{{ asset('backend') }}/dist/assets/images/ecommerce/orders/6.jpg"></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar cover-image avatar-sm"
                                                                data-bs-image-src="{{ asset('backend') }}/dist/assets/images/ecommerce/orders/1.jpg"></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar cover-image avatar-sm"
                                                                data-bs-image-src="{{ asset('backend') }}/dist/assets/images/ecommerce/orders/10.jpg"></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar cover-image avatar-sm"
                                                                data-bs-image-src="{{ asset('backend') }}/dist/assets/images/ecommerce/orders/2.jpg"></span>
