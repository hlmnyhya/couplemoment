                        ...
                        <div class="browser-stats">
                            <div class="row mb-3">
                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                    <img src="{{asset('backend')}}/dist/assets/images/browsers/chrome.svg" class="img-fluid"
                                        alt="img">
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                    <img src="{{asset('backend')}}/dist/assets/images/browsers/opera.svg" class="img-fluid"
                                        alt="img">
                                </div>
                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                    <div class="d-flex align-items-end justify-content-between mb-1">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                    <img src="{{asset('backend')}}/dist/assets/images/browsers/ie.svg" class="img-fluid"
                                        alt="img">
                                </div>
                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                    <div class="d-flex align-items-end justify-content-between mb-1">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                    <img src="{{asset('backend')}}/dist/assets/images/browsers/firefox.svg" class="img-fluid"
                                        alt="img">
                                </div>
                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                    <div class="d-flex align-items-end justify-content-between mb-1">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                    <img src="{{asset('backend')}}/dist/assets/images/browsers/edge.svg" class="img-fluid"
                                        alt="img">
                                </div>
                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                    <div class="d-flex align-items-end justify-content-between mb-1">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                    <img src="{{asset('backend')}}/dist/assets/images/browsers/safari.svg" class="img-fluid"
                                        alt="img">
                                </div>
                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                    <div class="d-flex align-items-end justify-content-between mb-1">
                            ...
                            <div class="row">
                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                    <img src="{{asset('backend')}}/dist/assets/images/browsers/netscape.svg" class="img-fluid"
                                        alt="img">
                                </div>
                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                    <div class="d-flex align-items-end justify-content-between mb-1">
                                    ...
                                    <table class="table table-bordered text-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar cover-image avatar-sm" data-bs-image-src="{{asset('backend')}}/dist/assets/images/ecommerce/orders/9.jpg"></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar cover-image avatar-sm" data-bs-image-src="{{asset('backend')}}/dist/assets/images/ecommerce/orders/11.jpg"></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar cover-image avatar-sm" data-bs-image-src="{{asset('backend')}}/dist/assets/images/ecommerce/orders/4.jpg"></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar cover-image avatar-sm" data-bs-image-src="{{asset('backend')}}/dist/assets/images/ecommerce/orders/8.jpg"></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar cover-image avatar-sm" data-bs-image-src="{{asset('backend')}}/dist/assets/images/ecommerce/orders/6.jpg"></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar cover-image avatar-sm" data-bs-image-src="{{asset('backend')}}/dist/assets/images/ecommerce/orders/1.jpg"></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar cover-image avatar-sm" data-bs-image-src="{{asset('backend')}}/dist/assets/images/ecommerce/orders/10.jpg"></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar cover-image avatar-sm" data-bs-image-src="{{asset('backend')}}/dist/assets/images/ecommerce/orders/2.jpg"></span>
