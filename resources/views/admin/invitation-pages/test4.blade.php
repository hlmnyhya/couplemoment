...
<body>
    <div class="image-container-c">
        <div class="image-column-c">
            ...
            <div class="text2-d">
                <div class="animate__animated animate__fadeInUp">Rabu</div>
            </div>
            <div class="text3-d">
                <div class="animate__animated animate__fadeInUp">Desember</div>
            </div>
            <div class="text4-d">
                <div class="animate__animated animate__fadeInUp">13</div>
            </div>
            <div class="text5-d">
