            ...
            <div class="main-header-container container-fluid">
                ...
                <div class="header-content-right">
                                    ...
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start mb-0">
                                                <div>
                                                    <a class="mb-0 fs-13 text-dark fw-semibold"
                                                        href="cart.html">Flower Pot for Home Decor</a>
                                    ...
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start mb-0">
                                                <div>
                                                    <a class="mb-0 fs-13 text-dark fw-semibold"
                                                        href="cart.html">Stylish Rockerz 255 Ear Pods</a>
                                                    <div class="min-w-fit-content">
                                                        <span>Status: <span class="text-success">In Stock</span></span>
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1 d-flex align-items-center my-auto">
                                            <div>
                                                <p class="mb-0 fw-semibold"><a href="notifications.html">New
                                                        Application received</a></p>
                                                <span class="text-muted fw-normal fs-12 header-notification-text">3
                                                    days ago</span>
                                            </div>
                                        ...
                                        <div class="flex-grow-1 d-flex align-items-center my-auto">
                                            <div>
                                                <p class="mb-0 fw-semibold"><a href="notifications.html">Your Product
                                                        Delivered</a></p>
                                                <span class="text-muted fw-normal fs-12 header-notification-text">30
                                                    min ago</span>
                                            </div>
                                            <div class="ms-auto my-auto">
                                                <a aria-label="anchor" href="javascript:void(0);"
                    ...
                    <div class="header-element">
                        ...
                        <a aria-label="anchor" href="#" class="header-link switcher-icon"
                    ...
                    <ul class="main-menu">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        <li class="slide">
                                            <a href="filemanager-details.html" class="side-menu__item"> File
                                                Details</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="two-step-verification.html" class="side-menu__item">Two Step
                                        Verification</a>
                                </li>
                                <li class="slide">
                                            ...
                                            <div>
                                                <ul class="nav nav-pills nav-justified gx-3 tab-style-6 d-sm-flex d-block "
                                                    ...
                                                    <li class="nav-item rounded" role="presentation">
                                                        <button class="nav-link active" id="activity-tab"
                                                            data-bs-toggle="tab" data-bs-target="#activity-tab-pane"
                                                    ...
                                                    <li class="nav-item rounded" role="presentation">
                                                        <button class="nav-link" id="gallery-tab"
                                                            data-bs-toggle="tab" data-bs-target="#gallery-tab-pane"
                                                            type="button" role="tab"
                                                    ...
                                                    <li class="nav-item rounded" role="presentation">
                                                        <button class="nav-link" id="posts-tab"
                                                    ...
                                                    <ul class="list-unstyled profile-timeline">
                                                        <li>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="text-muted mb-2">
                                                                    <span class="text-default"><b>Barnes vare</b>
                                                                        Shared project</span>
                                                                </p>
                                                                <p class="text-muted fs-12 mb-0">Added 1 attachment
                                                                    <strong>docfile.doc</strong></p>
                                                                <div class="btn-group file-attach mt-3"
                                                                    role="group" aria-label="Basic example">
                                                                    <button type="button"
                                                                        class="btn btn-sm btn-primary-light">
                                                                        <span class="ri-file-line me-2"></span>
                                                                        Image_file.jpg
                                                                    </button>
                                                                    <button type="button"
                                                                        class="btn btn-sm btn-primary-light"
                                                        ...
                                                        <li>
                                                            <div>
                                                                ...
                                                                <p class="text-muted mb-2">
                                                                    <span class="text-default"><b>Alzbeth Aren</b>
                                                                        Shared project</span>.
                                                                </p>
                                                                <p class="text-muted mb-0">
                                                                    ...
                                                                    rerum excepturi aperiam ipsam temporibus inventore
                                                                    ullam tempora eligendi libero sequi dignissimos
                                                        ...
                                                        <li>
                                                            <div>
                                                                <span
                                                                    class="fs-12 text-muted fw-semibold text-end  ">11,Dec
                                                                    2023</span>
                                                                <span
                                                                    class="avatar avatar-sm avatar-rounded profile-timeline-avatar">
                                                                ...
                                                                <p class="text-muted mb-1">
                                                                    <span class="text-default"><b>Melissa Blue</b>
                                                                        liked your post <b>travel excites</b></span>.
                                                                </p>
                                                                <p class="text-muted">you are already feeling the
                                                                    tense atmosphere of the video playing in the
                                                                    background</p>
                                                                <p class="profile-activity-media mb-0">
                                                                    <a href="javascript:void(0);">
                                                                        <img src="../assets/images/media/media-12.jpg"
                                                                            class="m-1" alt="">
                                                                    </a>
                                                                    <a href="javascript:void(0);">
                                                        ...
                                                        <li>
                                                            <div>
                                                                ...
                                                                <p class="text-muted mb-2">
                                                                    <span class="text-default"><b>Json Smith</b>
                                                                        reacted to the post 👍</span>.
                                                                </p>
                                                                <p class="text-muted mb-0">
                                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                                    elit. Repudiandae, repellendus rem rerum excepturi
                                                        ...
                                                        <li>
                                                            <div>
                                                                ...
                                                                <p class="text-muted mb-2">
                                                                    <span class="text-default"><b>Alicia Keys</b>
                                                                        shared a document with <b>you</b></span>.
                                                                </p>
                                                                <p class="profile-activity-media mb-0">
                                                                    <a href="javascript:void(0);">
                                                                        <img src="../assets/images/media/media-10.jpg"
                                                                            alt="">
                                                                    </a>
                                                        ...
                                                        <li>
                                                            <div>
                                                                ...
                                                                <p class="profile-activity-media mb-0">
                                                                    <a href="javascript:void(0);">
                                                                        <img src="../assets/images/media/media-15.jpg"
                                                                            alt="">
                                                                    </a>
                                                                    <a href="javascript:void(0);">
                                                                        <img src="../assets/images/media/media-16.jpg"
                                                                            alt="">
                                                                    </a>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <li>
                                                            <div>
                                                                ...
                                                                <p class="text-muted mb-2">
                                                                    <span class="text-default"><b>You</b> shared a
                                                                        post with 4 people
                                                        ...
                                                        <li>
                                                            <div>
                                                                ...
                                                                <p class="text-muted">Technology id developing rapidly
                                                                    kepp uo your work 👌</p>
                                                                <p class="profile-activity-media mb-0">
                                                                    <a href="javascript:void(0);">
                                                            ...
                                                            <div class="card custom-card shadow-none border">
                                                                <div class="card-body p-4">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <p class="mb-0 fw-semibold">Samantha May
                                                                            </p>
                                                            ...
                                                            <div class="card custom-card shadow-none border">
                                                                <div class="card-body p-4">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <p class="mb-0 fw-semibold">Andrew
                                                                                Garfield</p>
                                                                            <p class="fs-12 op-7 mb-1 text-muted">
                                                            ...
                                                            <div class="card custom-card shadow-none border">
                                                                <div class="card-body p-4">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <p class="mb-0 fw-semibold">Jessica Cashew
                                                                            </p>
                                                                            <p class="fs-12 op-7 mb-1 text-muted">
                                                            ...
                                                            <div class="card custom-card shadow-none border">
                                                                <div class="card-body p-4">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <p class="mb-0 fw-semibold">Simon Cowan
                                                                            </p>
                                                                            <p class="fs-12 op-7 mb-1 text-muted">
                                                                                jessicacashew143@gmail.com</p>
                                                                            <span
                                                            ...
                                                            <div class="card custom-card shadow-none border">
                                                                <div class="card-body p-4">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <p class="mb-0 fw-semibold">Amanda nunes
                                                                            </p>
                                                                            <p class="fs-12 op-7 mb-1 text-muted">
                                                            ...
                                                            <div class="card custom-card shadow-none border">
                                                                <div class="card-body p-4">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <p class="mb-0 fw-semibold">Mahira Hose
                                                                            </p>
                                                                            <p class="fs-12 op-7 mb-1 text-muted">
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="media media-xs overflow-visible">
                                    <img class="avatar bradius avatar-xl me-3" src="../assets/images/faces/12.jpg"
                                        alt="avatar-img">
                                ...
                                <div class="media media-xs overflow-visible mt-4">
                                    <img class="avatar bradius avatar-xl me-3" src="../assets/images/faces/2.jpg"
                                        alt="avatar-img">
                                    <div class="media-body valign-middle">
                                ...
                                <div class="media media-xs overflow-visible mt-4">
                                    <img class="avatar bradius avatar-xl me-3" src="../assets/images/faces/9.jpg"
                                        alt="avatar-img">
                                    <div class="media-body valign-middle">
                                ...
                                <div class="media media-xs overflow-visible mt-4">
                                    <img class="avatar bradius avatar-xl me-3" src="../assets/images/faces/4.jpg"
                                        alt="avatar-img">
                                    <div class="media-body valign-middle">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 ps-sm-0 my-auto">
                                    <div class="d-flex align-items-end justify-content-between ms-2">
                                        ...
                                        <div>
                                            <a aria-label="anchor" href="javascript:void(0)"
                                                class="text-primary"><i class="fe fe-settings me-1"></i></a>
                                            <a aria-label="anchor" href="javascript:void(0)"
                                                class="text-primary"><i class="fe fe-x"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 ps-sm-0 my-auto">
                                    <div class="d-flex align-items-end justify-content-between ms-2">
                                        ...
                                        <div>
                                            <a aria-label="anchor" href="javascript:void(0)"
                                                class="text-primary"><i class="fe fe-settings"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
