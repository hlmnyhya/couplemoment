                                        ...
                                        <div class="d-flex mt-sm-0 mt-2 align-items-center">
                                            <div class="input-group">
                                                <input type="text" class="form-control bg-light border-0"
                                                    placeholder="Search Undangan" aria-describedby="search-contact-member">
                                            ...
                                            <button class="btn btn-icon btn-secondary-light ms-2" data-bs-toggle="tooltip"
                                                data-bs-placement="top" data-bs-title="Add Contact"><i
                                ...
                                <div class="card-body contact-action">
                                    ...
                                    <div class="d-flex align-items-top ">
                                        <div class="d-flex flex-fill flex-wrap gap-2">
                                            <div class="avatar avatar-xl avatar-rounded me-3">
                                                <img src="{{ $invitation->theme->background_img }}" alt="">
                                            </div>
                                            <div>
                                                <h6 class="mb-1 fw-semibold">
                                                    {{ $invitation->title_invitation }}
                                                </h6>
                                                <p class="mb-1 text-muted contact-mail text-truncate">
                                                    {{ $invitation->time_invitation }} - {{ $invitation->date_invitation }}
                                                    / {{ $invitation->timezone }}
                                                </p>
                                    ...
                                    <div
                                        ...
                                        <button aria-label="button"
                                            class="btn btn-sm btn-icon btn-light contact-hover-dropdown1" type="button">
    ...
    <script>
        function confirmDelete(invitationId) {
            if (confirm("Are you sure you want to delete this invitation?")) {
                document.getElementById('delete-form-' + invitationId).submit();
            }
        }
    </script>
@endsection
