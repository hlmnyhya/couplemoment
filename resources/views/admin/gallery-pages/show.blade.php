                                    ...
                                    @forelse ($gallery->photos as $photo)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src="{{ asset($photo->file_path) }}" alt="Preview" width="100px" height="100px">
                                            </td>
                                            <td>
                                            {{-- detail --}}
                                            {{-- <a href="" class="btn btn-primary btn-sm justify-center">Detail</a> --}}
                                            {{-- hapus --}}
                                            <a  id="delete" href="{{route('photo.delete', $photo->id)}}" class="btn btn-danger btn-sm justify-center">Delete</a>
