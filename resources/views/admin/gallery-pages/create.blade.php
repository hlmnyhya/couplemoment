                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="gallery_name" class="form-control" id="gallery_name" placeholder="">
                            </div>
                            <div class="mb-3">
                                <label for="photos" class="form-label fs-14 text-dark">Tambah Foto Disini</label>
                                <input type="file" name="photos[]" id="inputPhoto" multiple class="form-control @error('photos') is-invalid @enderror">
        ...
        if (window.FileReader) {
            ...
            $.each(input.files, function (i, file) {
                ...
                reader.onload = function (e) {
                    ...
                    var imageContainer = $('<div class="image-container"><img src="' + e.target.result + '" alt="Preview"/><span class="remove-image" data-index="' + i + '">&times;</span></div>');
