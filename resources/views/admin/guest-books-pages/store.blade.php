        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title my-auto">Form Tambah Guest</h1>
                    <div>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0)">Forms</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Form Tambah Guest</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                                                ...
                                                <tr class="tr-clone">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="guest_name[]"
                                                            placeholder="Guest name" aria-label="Guest name">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-success btn-add">+</a>
                                                        <a class="btn btn-warning btn-remove">-</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
