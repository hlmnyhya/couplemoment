    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title my-auto">Form Update Guest</h1>
                <div>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)">Forms</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Form Update Guest</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <form method="POST" action="{{ route('guestbook.update', ['id' => $guest->id]) }}">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table text-nowrap table-bordered table-data" id="table-data">
                                    <thead>
                                        <tr>
                                        ...
                                        <tr class="tr-clone">
                                            <td>
                                                <input type="text" class="form-control" name="guest_name" placeholder="Guest name"
                                                    aria-label="Guest name" value="{{ $guest->guest_name }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="phone" value="{{ $guest->phone }}" placeholder="Phone"
                                                    aria-label="Phone">
                                            </td>
                                        </tr>
                                    </tbody>
