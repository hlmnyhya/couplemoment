                                ...
                                <div class="d-sm-flex d-block align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex mt-sm-0 mt-2 align-items-center">
                                        <div class="input-group">
                                            <input type="text" id="searchGuest" class="form-control bg-light border-0" placeholder="Search Guest" aria-describedby="search-contact-member">
                                        ...
                                        <a href="{{ route('guestbook.create') }}" class="btn btn-icon btn-secondary-light ms-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add Guest"><i class="ri-add-line"></i></a>
                    ...
                    <div class="card custom-card">
                        <div class="card-body contact-action">
                            ...
                            <div class="d-flex align-items-center justify-content-center gap-2 contact-hover-buttons">
                                <a href="{{ route('guestbook.edit', $guest->id) }}" class="btn btn-sm btn-light contact-hover-btn"><i class="ri-edit-line"></i></a>

                                <form action="{{ route('guestbook.destroy', ['id' => $guest->id]) }}" method="POST" class="contact-hover-btn">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-light btn-icon contact-hover-dropdown1" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="ri-eraser-fill"></i></button>
                                </form>

                                <button aria-label="button" class="btn btn-sm btn-icon btn-light contact-hover-dropdown1" id="liveToastBtn" type="button" data-url="{{ $guest->url }}">
                                    <i class="ri-link"></i>
                                </button>
                            </div>
                        </div>
